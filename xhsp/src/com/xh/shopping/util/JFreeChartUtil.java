 ...
 * 版权所有 (C)2015
 * 
 * 文件名称：JFreeChartTesty.java
 * 内容摘要：JFreeChartTesty.java
 * 当前版本：TODO
 * 作        者：李加蒙
 * 完成日期：2016年8月11日 下午4:13:01
 * 修改记录：
 * 修改日期：2016年8月11日 下午4:13:01
 * 版   本 号：
 * 修   改 人：
 * 修改内容：
 ************************************************************************************************/
...
/**
 * @filename 文件名称：JFreeChartTesty.java
 * @contents 内容摘要：
 */
public class JFreeChartUtil {
	private static JFreeChartUtil jFreeChartUtil = null;

	static {
		if (jFreeChartUtil == null) {
			jFreeChartUtil = new JFreeChartUtil();
		}
	}

	public static JFreeChartUtil getInstance() {
		return jFreeChartUtil;
	}
	 ...
	 * @param chart
	 */
	private static void setFont(JFreeChart chart) {
